...
def get_derivators(saltKey, saltIV):
    pbkdf2Key = PBKDF2HMAC (algorithm=SHA256, length=32, salt=saltKey, iterations=100000, backend=backend)
    pbkdf2IV = PBKDF2HMAC(algorithm=SHA256, length=16, salt=saltIV, iterations=100000, backend=backend)
